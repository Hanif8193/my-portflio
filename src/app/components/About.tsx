...
function About() {
  ...
  <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
      <Image className=' object-center object-cover  border-2xl rounded-3xl border-red-600 shadow-2xl  mx-auto' src={Im}alt='Hanif'width={250}height={250} />
...
<br />
<br />
Now a day I am learnt Typescript & Next.js is running from G.I.A.I.C from Karachi. 
